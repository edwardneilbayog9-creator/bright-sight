...
<head>
  <meta charset="UTF-8" />
  <title>BrightEdge Report - ${detection.patientName}</title>
  <style>
...
<body>
  <div style="border-bottom:3px solid #2c3e50;padding-bottom:16px;margin-bottom:24px;">
    <h1 style="font-size:22px;font-weight:700;color:#2c3e50;margin-bottom:2px;">BRIGHTEDGE EYE CLINIC</h1>
  ...
  <div style="margin-top:16px;text-align:center;">
    <p style="font-size:10px;color:#aaa;">This report was generated by BrightEdge Pre-Diagnosis System • ${generatedAt.toLocaleString()}</p>
  </div>
